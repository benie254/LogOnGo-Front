...
@Component({
  selector: 'app-add-diesel-pump-four',
  templateUrl: './add-diesel-pump-four.component.html',
  styleUrls: ['./add-diesel-pump-four.component.css']
})
export class AddDieselPumpFourComponent implements OnInit {
  pumpFour: Pump;
  info: Fuel;
  closed: boolean;
  errMsg = '';
