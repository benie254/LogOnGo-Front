...
@Component({
  selector: 'app-profile-credit-logs',
  templateUrl: './profile-credit-logs.component.html',
  styleUrls: ['./profile-credit-logs.component.css']
})
export class ProfileCreditLogsComponent implements OnInit {
  page: number = 1;
  count: number = 0;
  tableSize: number = 2;
  ...
  getCreditCard(id: number){
    this.creditCardService.getUserCreditCardLogs(id).subscribe(
      data => {
